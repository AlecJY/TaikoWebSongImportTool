...
fun main(args: Array<String>) {
    ...
    val category by argParser.option(ArgType.Choice<Genre>(), "category", "c", "The default category of songs. It would be overwritten if genre.ini or box.def is existed.");
